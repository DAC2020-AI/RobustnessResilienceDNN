...
class cifar100RESNET(ModelBase):
  def __init__(self):
    super(cifar100RESNET,self).__init__('cifar100','CiFar100RESNET')
    self.layer_ids             = []
    ...
    self.l2 = 5e-4
    self.lr = 0.1
    self.weights_file_name = "experiments/train/trained_models/cifar100_resnet_temp"
  ...
  def build_model(self,faults=[]):
    module = models.resnet50(num_classes=100)
