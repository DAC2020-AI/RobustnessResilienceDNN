...
import dl_models.models.cifar100.shufflenetv2 as shufflenetv2

class cifar100SHUFFLENET(ModelBase):
  def __init__(self):
    super(cifar100SHUFFLENET,self).__init__('cifar100','CiFar100SHUFFLENET')
    self.layer_ids             = []
    ...
    self.l2 = 5e-4
    self.lr = 0.1
    self.weights_file_name = "experiments/train/trained_models/cifar100_shufflenet_temp"
  ...
  def build_model(self,faults=[]):
    module = shufflenetv2.shufflenetv2()
