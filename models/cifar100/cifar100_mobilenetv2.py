...
import dl_models.models.cifar100.mobilenetv2 as mobilenetv2

class cifar100MOBILENET(ModelBase):
  def __init__(self):
    super(cifar100MOBILENET,self).__init__('cifar100','CiFar100MOBILENET')
    self.layer_ids             = []
    ...
    self.l2 = 5e-4
    self.lr = 0.1
    self.weights_file_name = "experiments/train/trained_models/cifar100_mobilenet_temp"
