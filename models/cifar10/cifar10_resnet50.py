...
import dl_models.models.cifar10.resnet50 as resnet

class cifar10RESNET50(ModelBase):
  def __init__(self):
    super(cifar10RESNET50,self).__init__('cifar10','CiFar10RESNET50')
    self.layer_ids             = []
    ...
    self.l2 = 5e-4
    self.lr = 0.1
    self.weights_file_name = "experiments/train/trained_models/cifar10_resnet50_temp"
