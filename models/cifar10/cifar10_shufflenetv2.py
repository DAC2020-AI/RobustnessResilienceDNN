...
import dl_models.models.cifar10.shufflenetv2 as shufflenetv2

class cifar10SHUFFLENET(ModelBase):
  def __init__(self):
    super(cifar10SHUFFLENET,self).__init__('cifar10','CiFar10SHUFFLENET')
    self.layer_ids             = []
    ...
    self.l2 = 5e-4
    self.lr = 0.1
    self.weights_file_name = "experiments/train/trained_models/cifar10_shufflenet_temp"
